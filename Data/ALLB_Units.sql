...
--————————————REQUIRES————————————
    INSERT INTO RequirementSets
        (RequirementSetId, RequirementSetType) VALUES
            ...
            ('REQSET_AL_PLAYER_LEADS_DISTRICTS', 'REQUIREMENTSET_TEST_ALL'),
            ('REQSET_AL_PLAYER_LAGS_DISTRICTS', 'REQUIREMENTSET_TEST_ALL'),

            ('REQSET_AL_HARUNA_RS_2', 'REQUIREMENTSET_TEST_ALL'),
    ...
    INSERT INTO RequirementSetRequirements
        (RequirementSetId, RequirementId) VALUES
            ('REQSET_AL_HARUNA_RS_2', 'REQ_AL_UNIT_ADJACENT_HIMEKA_OR_TAKANE'),
            ('REQSET_AL_HARUNA_RS_2', 'REQ_AL_UNIT_IS_ATTACKER'),
            ...
            ('REQSET_AL_PLAYER_LEADS_DISTRICTS', 'REQUIRES_MAJOR_CIV_OPPONENT'),
            ('REQSET_AL_PLAYER_LEADS_DISTRICTS', 'REQUIRES_MET_30_TURNS_AGO'),
            ('REQSET_AL_PLAYER_LEADS_DISTRICTS', 'REQ_AL_LEADS_DISTRICTS'),

            ('REQSET_AL_PLAYER_LAGS_DISTRICTS', 'REQUIRES_MAJOR_CIV_OPPONENT'),
            ('REQSET_AL_PLAYER_LAGS_DISTRICTS', 'REQUIRES_MET_30_TURNS_AGO'),
            ('REQSET_AL_PLAYER_LAGS_DISTRICTS', 'REQ_AL_LAGS_DISTRICTS'),
    ...
    INSERT INTO Requirements
        (RequirementId, RequirementType, Inverse) VALUES
            ...
            ('REQ_AL_PLOT_APPEAL_4', 'REQUIREMENT_PLOT_IS_APPEAL_BETWEEN', 0),

            ('REQ_AL_LEADS_DISTRICTS', 'REQUIREMENT_PLAYER_DISTRICT_THRESHOLD', 0),
            ('REQ_AL_LAGS_DISTRICTS', 'REQUIREMENT_PLAYER_DISTRICT_THRESHOLD', 0),
    ...
    INSERT INTO RequirementArguments
        (RequirementId, Name, Value) VALUES
            ...
            ('REQ_AL_PLOT_APPEAL_4', 'MinimumAppeal', '4'),

            ('REQ_AL_PLOT_HAS_STAGE', 'DistrictType', 'DISTRICT_AL_STAGE'),

            ('REQ_AL_LEADS_DISTRICTS', 'DistrictPercentThreshold', '80'),
            ('REQ_AL_LEADS_DISTRICTS', 'MinDistrictsNeeded', '3'),
            ('REQ_AL_LEADS_DISTRICTS', 'AboveThreshold', 1),

            ('REQ_AL_LAGS_DISTRICTS', 'DistrictPercentThreshold', '60'),
            ('REQ_AL_LAGS_DISTRICTS', 'MinDistrictsNeeded', '3'),
            ('REQ_AL_LAGS_DISTRICTS', 'AboveThreshold', 0),

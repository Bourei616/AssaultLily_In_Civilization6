-- PROMISE MODIFIERS --
    ...
    INSERT INTO AL_PromiseEffects
     ...
     VALUES (1,     'SHENLIN_YUJIA',   'SHENLIN',  'YUJIA',    1,              1,      1,          'MODIFIER_PLAYER_UNIT_ADJUST_UNIT_EXPERIENCE_MODIFIER',     1,              25,         NULL                ),
            ...
            (35,     'TAKANE_KANAHO',   'TAKANE',  'KANAHO',    1,              1,      1,          'MODIFIER_PLAYER_UNIT_ADJUST_UNIT_EXPERIENCE_MODIFIER',     1,              25,         NULL                ),
            (36,     'TAKANE_KANAHO',   'TAKANE',  'KANAHO',    2,              1,      0,          'MODIFIER_PLAYER_GRANT_INFLUENCE_TOKEN',                    NULL,           2,          NULL                ),
            (37,     'TAKANE_KANAHO',   'TAKANE',  'KANAHO',    3,              1,      1,          'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',                        1,              2,          NULL                ),
            (38,     'TAKANE_KANAHO',   'TAKANE',  'KANAHO',    4,              1,      2,          'MODIFIER_PLAYER_ADJUST_GOVERNOR_POINTS',                   NULL,           2,          NULL                ),

            (39,     'AKARI_HIMEKA',   'AKARI',  'HIMEKA',    1,              1,      1,          'MODIFIER_PLAYER_UNIT_ADJUST_UNIT_EXPERIENCE_MODIFIER',     1,              25,         NULL                ),
            (40,     'AKARI_HIMEKA',   'AKARI',  'HIMEKA',    2,              1,      0,          'MODIFIER_PLAYER_GRANT_INFLUENCE_TOKEN',                    NULL,           2,          NULL                ),
            (41,     'AKARI_HIMEKA',   'AKARI',  'HIMEKA',    3,              1,      2,          'MODIFIER_PLAYER_GRANT_RANDOM_CIVIC_BOOST_GOODY_HUT',       NULL,           2,          'CAPTURED_CITY'     ),
            (42,     'AKARI_HIMEKA',   'AKARI',  'HIMEKA',    4,              1,      2,          'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY_BOOST_GOODY_HUT',  NULL,           3,          'CAPTURED_CITY'     ),
...
-- TRAINNING MODIFIERS --
    ...
    INSERT INTO RequirementSets
        ...
        ('REQSET_AL_AOE_LAND_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL'),
    ...
    INSERT INTO RequirementSetRequirements
        ...
        ('REQSET_AL_AOE_LAND_REQUIREMENTS', 'AOE_REQUIRES_LAND_DOMAIN'),
        ('REQSET_AL_AOE_LAND_REQUIREMENTS', 'AOE_REQUIRES_OWNER_ADJACENCY'),
...
-- TRAINNING ABILITIES --
    ...
    INSERT INTO Modifiers
        ...
        ('BONUS_AL_TRAINNING_TESTAMENT', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 'REQSET_AL_AOE_LAND_REQUIREMENTS'),
        ...
        ('BONUS_AL_TRAINNING_HELIOSPHERE', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 'REQSET_AL_AOE_LAND_REQUIREMENTS'),
        ...
        ('BONUS_AL_TRAINNING_REGISTER', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 'REQSET_AL_AOE_LAND_REQUIREMENTS'),
